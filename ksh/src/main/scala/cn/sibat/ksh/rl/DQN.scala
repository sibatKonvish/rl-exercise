...
/**
  ...
  */
class DQN(env: Environment) extends RL {
...
object DQN {
  def main(args: Array[String]): Unit = {
    ...
    val ods = Array((0, 1, 1, 3, 2), (1, 2, 2, 1, 3), (2, 4, 0, 0, 4), (3, 3, 3, 0, 1)) //
    env.setODS(ods)
    val sarsa = new DQN(env)
    sarsa.build_model("ksh/src/main/resources/dqn-2")
    ...
    val model = new File("ksh/src/main/resources/dqn-2")
